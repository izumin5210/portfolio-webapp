...
/**
 * Copied from Simple Icons
 */
const SpeakerDeckIcon = React.forwardRef<SVGSVGElement, SVGProps<SVGSVGElement>>(function SpeakerDeckIcon(props, ref) {
  return (
    <svg fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" ref={ref} {...props}>
